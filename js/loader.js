...
function buildTicksAndExit() {
  ...
  const TICK_DUR  = 0.5
  const IMG_DUR   = 0.7
  const EACH_TICK = window.matchMedia('(min-width: 1600px)').matches ? 0.007 : 0.009  // écart par tick — vague clairement perceptible, réduit sur grand écran (plus de ticks à balayer)
